...
from Network.CIF-SCVIT import CIF-SCVIT
...
def main_worker(gpu, args):
    ...
    model = CIF-SCVIT(model_num=args.in_channels,
                         out_channels=args.out_channels,
                         image_size=inf_size,
                         window_size=(4, 4, 4),
                         )
    model.load_state_dict(torch.load('./model/model_final.pt'))
